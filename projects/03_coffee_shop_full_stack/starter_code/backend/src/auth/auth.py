...
def get_token_auth_header():
    # get header from request - raise an error if none
    ...
    # split bearer and the token - raise an error if invalid
    ...
    # store and return token part of the header
    token = auth_parts[1]
    return token
...
def check_permissions(permission, payload):
    ...
    # check if permission string in payload array
